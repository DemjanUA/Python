      ...
      <div className="home__page-wrapper">
        <Row gutter={[16, 24]}>
          <Col span={6}>
            ...
            <Row>
              <Col span={4} offset={6}>
                <CheckableButton type="highlightOutlined" checked={this.state.isPaintMode} onClick={() => this.setState({ isPaintMode: !this.state.isPaintMode })} />
              </Col>
              <Col span={4}>
                <CheckableButton type="deleteOutlined" onClick={this.onClear} />
              </Col>
              <Col span={4}>
                <ColorPicker color={this.state.color} onChangeComplete={color => this.setState({ color: color.hex })}/>
              </Col>
            </Row>
            <Row>
